        ...
        >
          ...
          <div className="sc-list">
            {[
              ...
              'maxClimbAltitude',
              'maxDescendAltitude',
              'maxTotalTripDuration',
            ].map((v) => {
              const numItem = (statistics as any)?.[
                v
              ] as protoRoot.trip.TripHistoricalStatistics.INumItem
              ...
              let num: any = Number(numItem?.num)
              if (v === 'maxDistance') {
                num = Math.round(num / 100) / 10
              }
              if (v === 'maxSpeed') {
                num = Math.round(num * 3.6 * 10) / 10
              }
              if (v === 'fastestAverageSpeed') {
                num = Math.round(num * 3.6 * 10) / 10
              }
              if (v === 'maxTotalTripDuration') {
                num = num / 3600
              }
