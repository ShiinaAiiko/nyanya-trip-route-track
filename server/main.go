...
func main() {
	...
	conf.G.Go(func() error {
		...
		// openAIConf := openai.DefaultConfig("6c620d1b0c954ea8a7f00bb68e2b67be.376kVik9VPNAN0Bt") // 这里传入任意字符串作为 fake key
		// openAIConf.BaseURL = "https://api.z.ai/api/paas/v4"
		// openAIConf := openai.DefaultConfig("6c620d1b0c954ea8a7f00bb68e2b67be.376kVik9VPNAN0Bt") // 这里传入任意字符串作为 fake key
		// openAIConf.BaseURL = "https://open.bigmodel.cn/api/paas/v4"
		// openAIConf := openai.DefaultConfig("AIzaSyAoaGN3Gr4whiI8Q5aVNS9KfmPZMvEyF5U")
		// openAIConf.BaseURL = "https://generativelanguage.googleapis.com/v1beta/openai/" // LiteLLM Proxy 地址
