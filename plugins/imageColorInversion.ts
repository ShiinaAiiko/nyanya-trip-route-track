...
//         // console.log("rgbaRanges", rgbaRanges)
//         rgbaRanges.forEach((rgbaRange, ri) => {
//           if (
...
//             imageData.data[i * 4] = toRgba[ri][0]
//             imageData.data[i * 4 + 1] = toRgba[ri][1]
//             imageData.data[i * 4 + 2] = toRgba[ri][2]
//             imageData.data[i * 4 + 3] = Math.round(toRgba[ri][3] * 255)
//           }
//         })
