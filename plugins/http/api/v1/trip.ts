...
export const tripApi = {
  ...
  async ResumeTrip(params: protoRoot.trip.ResumeTrip.IRequest) {
    const { apiUrls } = store.getState().api

    return await Request<protoRoot.trip.ResumeTrip.IResponse>(
      {
        method: 'POST',
        data: PARAMS<protoRoot.trip.ResumeTrip.IRequest>(
          params,
          protoRoot.trip.ResumeTrip.Request
        ),
        url: getUrl(apiUrls.v1.baseUrl, apiUrls.v1.resumeTrip),
      },
      protoRoot.trip.ResumeTrip.Response
    )
  },
  ...
  async UpdateTrips(params: protoRoot.trip.UpdateTrips.IRequest) {
    const { apiUrls } = store.getState().api

    return await Request<protoRoot.trip.UpdateTrips.IResponse>(
      {
        method: 'POST',
        data: PARAMS<protoRoot.trip.UpdateTrips.IRequest>(
          params,
          protoRoot.trip.UpdateTrips.Request
        ),
        url: getUrl(apiUrls.v1.baseUrl, apiUrls.v1.updateTrips),
      },
      protoRoot.trip.UpdateTrips.Response
    )
  },
  ...
  async UpdateTripNetworkStatus(
    params: protoRoot.trip.UpdateTripNetworkStatus.IRequest
  ) {
    const { apiUrls } = store.getState().api

    return await Request<protoRoot.trip.UpdateTripNetworkStatus.IResponse>(
      {
        method: 'POST',
        data: PARAMS<protoRoot.trip.UpdateTripNetworkStatus.IRequest>(
          params,
          protoRoot.trip.UpdateTripNetworkStatus.Request
        ),
        url: getUrl(apiUrls.v1.baseUrl, apiUrls.v1.UpdateTripNetworkStatus),
      },
